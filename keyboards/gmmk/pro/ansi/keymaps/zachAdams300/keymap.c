...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    [1] = LAYOUT(
        ...
        _______, KC_BTN1, KC_MS_U, KC_BTN2, KC_WH_U, _______, _______, _______, RGB_VAI, _______, _______, _______, _______, RESET,            _______,
        _______, KC_MS_L, KC_MS_D, KC_MS_R, KC_WH_D, _______, _______, _______, RGB_VAD, _______, _______, _______,          _______,          _______,
        _______,          KC_WBAK, _______, KC_WFWD, _______, _______, NK_TOGG, RGB_HUI, _______, _______, _______,          _______, RGB_MOD, _______,
...
bool isBlinkingCapsLockOn = false;
static uint16_t recordingTimer;
...
void rgb_matrix_indicators_advanced_user(uint8_t led_min, uint8_t led_max) {
    if (IS_HOST_LED_ON(USB_LED_CAPS_LOCK)) {
        ...
        if(timer_elapsed(recordingTimer) > 500) {
            isBlinkingCapsLockOn = !isBlinkingCapsLockOn;
            recordingTimer = timer_read();
        }

        if(isBlinkingCapsLockOn) {
